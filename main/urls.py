...
urlpatterns = [
    ...
    path('add_feedback_questions', add_feedback_questions, name='add_feedback_questions'),
    path('list_feedback_questions', list_feedback_questions, name='list_feedback_questions'),
